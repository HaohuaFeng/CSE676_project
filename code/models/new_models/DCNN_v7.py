...
class DCNN(nn.Module):
    def __init__(self, num_classes, input_channel = 1):
        ...
        self.do3 = nn.Dropout(0.65)
        
        self.attention = AttentionModule(512, 512)
        self.mhattention = multi_head_attention(channel=512, heads=8)
        self.resA = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, padding=1, stride=1)
        self.bn_resA = nn.BatchNorm2d(512)
        self.doA = nn.Dropout(0.65)
    ...
    def forward(self, x):
        ...
        out = self.bn1__(self.conv1__(out))
