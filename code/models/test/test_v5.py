...
# Add residual connection for attention layer
# saving path, will change when read optimizer_name
model_name = 'custom/v5_'
pth_save_path = ''
...
class DCNN(nn.Module):
    def __init__(self, num_classes, input_channel = 1):
        ...
        self.conv3_ = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn3_ = nn.BatchNorm2d(1024)
        self.res3 = nn.Conv2d(in_channels=512, out_channels=1024, kernel_size=3, padding=1)
        ...
        self.FC = nn.Sequential(
            nn.Linear(1024 * self.avg_pool_size**2, 512),
            nn.BatchNorm1d(512),
            nn.Dropout(0.25),
            nn.Linear(512, 512),
            nn.BatchNorm1d(512),
        ...
        self.attention = AttentionModule(1024, 1024)
        self.mhattention = multi_head_attention(channel=1024, heads=8)
        self.resA = nn.Conv2d(in_channels=1024, out_channels=1024, kernel_size=3, padding=1)
        self.bn_resA = nn.BatchNorm2d(1024)
